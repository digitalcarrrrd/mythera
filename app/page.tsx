...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <div className="bg-[#141714] border-b border-[#ffffff15] py-8 px-6 sm:px-12 text-center">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="text-left">
            <span className="eyebrow-text block mb-1 text-[#d6e8aa]">AUDITED FIRST-FILM BREAKDOWN</span>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="max-w-3xl mb-16">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="eyebrow-text text-xs text-[#d6e8aa]">THE REUSABLE STORY ENGINE</span>
            </div>
            ...
            <p className="mt-6 text-base sm:text-lg text-[#9ea399] leading-relaxed">
          ...
          <div className="p-8 sm:p-10 bg-[#141714] border-2 border-[#d6e8aa]/40 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl">
            <div>
              <h4 className="font-sans text-2xl font-black text-[#f3f3eb] mb-1">
      ...
      {/* SCREEN 5: Final CTA */}
      <section className="py-24 px-6 sm:px-12 bg-[#0c0e0d] border-t border-[#ffffff15] text-center">
        <div className="max-w-4xl mx-auto">
          <span className="eyebrow-text block mb-4 text-[#d6e8aa]">THE NEXT CHAPTER</span>
          <h2 className="font-sans text-4xl sm:text-6xl font-black tracking-tight text-[#f3f3eb] uppercase leading-tight">
            YOUR PLACE IN THE STORY STARTS HERE.
          </h2>
          <p className="mt-6 text-base text-[#9ea399] max-w-xl mx-auto mb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Link
              ...
              className="p-8 bg-[#141714] border-2 border-[#ffffff15] hover:border-[#d6e8aa] rounded-2xl transition-all group text-left shadow-xl hover:-translate-y-1"
            >
              <span className="text-[10px] font-mono uppercase text-[#d6e8aa] block mb-1 font-bold">FOR YOU</span>
              <strong className="font-sans text-xl font-black text-[#f3f3eb] block group-hover:text-[#d6e8aa]">
                Create My Film &rarr;
              </strong>
              <span className="text-xs text-[#9ea399] block mt-2">Trailer from $299</span>
            </Link>

            <Link
              href="/filmmaker/start?tier=film-cohort"
              className="p-8 bg-[#141714] border-2 border-[#d6e8aa] rounded-2xl transition-all group text-left shadow-2xl ring-1 ring-[#d6e8aa] hover:-translate-y-1"
            >
              <span className="text-[10px] font-mono uppercase text-[#d6e8aa] block mb-1 font-bold">FOR CREATORS</span>
              <strong className="font-sans text-xl font-black text-[#f3f3eb] block group-hover:text-[#d6e8aa]">
                Join Filmmaker &rarr;
              </strong>
              <span className="text-xs text-[#9ea399] block mt-2">Cohort from $749</span>
            </Link>

            <Link
              href="/studios/start"
              className="p-8 bg-[#141714] border-2 border-[#ffffff15] hover:border-white rounded-2xl transition-all group text-left shadow-xl hover:-translate-y-1"
            >
              <span className="text-[10px] font-mono uppercase text-[#d6e8aa] block mb-1 font-bold">FOR BRANDS & IP</span>
              <strong className="font-sans text-xl font-black text-[#f3f3eb] block group-hover:text-white">
                Start Studio Brief &rarr;
              </strong>
              <span className="text-xs text-[#9ea399] block mt-2">Pilots from $7,500</span>
            </Link>
          </div>
        </div>
      </section>
